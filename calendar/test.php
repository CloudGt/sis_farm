...
// put here the correct path to "../old/calendar/calendar.php"; don't move the file
// "../old/calendar/calendar.php" -- I think it's best if you leave it inside the
...
<h1>Calendar.php test</h1>
     ...
     <form action="../old/calendar/test.php" method="get">
