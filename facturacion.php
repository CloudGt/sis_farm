<?
	...
	$var="ALTER TABLE `homehealth`.`bodegam` ADD COLUMN `afecto` ENUM('S','N') DEFAULT 'S' NOT NULL AFTER `pedirx`; ";
	$go1=mysql_query($var,$link);
	
	$var2="UPDATE bodegam SET afecto='N' WHERE eticopopular='G'";
	$go2=mysql_query($var2,$link);
	
	envia_msg("actualización satisfacoria");
	cambiar_ventana("principal.php");
	exit;
