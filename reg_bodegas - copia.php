...
//Consultas y Popup's
	...
	if ($cod1 != 0)
	{
		$selec = "SELECT id_presenta, presentacion FROM Presentacion ORDER BY Presentacion";
        ...
        <tr>
          ...
          <td colspan="4">
            <div align="left"><span id="sprytextfield4">
              ...
              <span class="textfieldRequiredMsg">¿?</span></span><span class="Estilo59"> </span></div></td>
