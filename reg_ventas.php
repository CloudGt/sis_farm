...
<form name="Venta" id="Venta" method="post" action="reg_ventas.php?met=1">
	...
	if(!$cod1)	{	$cod1=$estecliente;	}	?>
                <select name="Clientes" class="Estilo110" id="Clientes" onChange="CambioOpcion('self',this,0)">
                  <option value="reg_ventas.php?cod2=<?php
	echo $cod2; ?>">Todos los Clientes</option>
                  <?														
            ...
            <tr>
              <td>
                ...
                <select name="select2" id="select2" onChange="CambioOpcion('self',this,0)">
                  <option value="reg_ventas.php?cod1=<?php
	echo $cod1; ?>">Todos los Productos</option>
                  <?														
...
Q. <?php echo $pventa ?></span></span></span></span></strong> <span class="Estilo125" style="font-size: 16px"><span class="Estilo110">
...
<form name="Factura" id="Factura" method="post" action="reg_ventas.php?met=2">
  <table width="90%" border="0" cellpadding="1" cellspacing="1" frame="border" rules="all">
    <tr>
      <td><table width="100%" border="1" align="center" cellpadding="1" cellspacing="1" frame="box" rules="rows">
          ...
          <?php
			...
			?>
          <tr>
            <td height="29" bgcolor="#F0F0F0"><div align="center"><span class="Estilo53 Estilo55"><?php
	echo $salio['factura'] ?>-<?php
	echo $salio['salida'] ?></span></div></td>
            <td width="35%" bgcolor="#DBEACD"><span class="Estilo53 Estilo55"><?php
	echo $salio['nproducto'] ?></span></td>
            <td width="15%" bgcolor="#F0F0F0"><div align="center"><span class="Estilo53 Estilo55"><?php
	echo $salio['presentacion'] ?></span></div></td>
	...
	echo $salio['cantidad'] ?></strong></span></div></td>
            <td width="10%" bgcolor="#DBEACD"><div align="right"><span class="Estilo53 Estilo55"><?php
	echo number_format($salio['descuentos'],2) ?></span></div></td>
	...
	echo number_format($salio['total'],2) ?></strong></span></div></td>
            <td width="1%"><a href="return_data.php?eli=1&id=<?php
	echo $salio['salida']; ?>" title="Retornar Medicamento.." target="mainFrame"><img src="images/iconos/button_drop.png" width="11" height="13" border="0"></a></td>
            <?php
	...
	echo number_format($totalg,2) ?></span></span></span></span></div>
...
<form name="Cancela" id="Cancela" method="post" action="rep_venta.php?dat=1">
  <table width="90%" border="1" cellpadding="1" cellspacing="1" bgcolor="#FFFFCC" frame="border" rules="all">
	...
	echo $ultima ?>" size="4" maxlength="8">
